...
plt.annotate(r'Mean squared error: '+str(round(mse_train, 1)), xy = (0.10, 0.90), xycoords = 'axes fraction', fontsize = text_font, c = 'b')
plt.annotate(r'Mean percent error: '+str(round(mpe_train, 2)), xy = (0.10, 0.83), xycoords = 'axes fraction', fontsize = text_font, c = 'b')
...
plt.ylabel('Predicted price [1000 Eur]', fontsize = label_font+4)
plt.tick_params(length=tick_major, width=tickwidth, left=True, bottom=True, right=True, top=True, direction = 'in', which='major', pad=tickpad, labelsize = ticksize+10)
plt.annotate(r'Mean squared error: '+str(round(mse_valid, 1)), xy = (0.10, 0.90), xycoords = 'axes fraction', fontsize = text_font, c = 'b')
plt.annotate(r'Mean percent error: '+str(round(mpe_valid, 2)), xy = (0.10, 0.83), xycoords = 'axes fraction', fontsize = text_font, c = 'b')
